...
import ReportingWalkthrough from "@/components/reporting/preview/ReportingWalkthrough";
    ...
    return (
      <main className="flex flex-1 flex-col items-center gap-6 p-8 pt-16 text-center">
        <div className="flex flex-col items-center gap-1">
          <h1 className="text-3xl font-bold text-foreground">Reporting</h1>
          <p className="text-foreground/60">See how branded client reports, valuation calculators, and AI-drafted commentary work before you sign in.</p>
        </div>
        <ReportingWalkthrough />
